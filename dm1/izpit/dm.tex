...
\begin{definicija}
    \df{Hamiltonov cikel} grafa je cikel, ki vsebuje vsa vozlišča grafa. \df{Hamiltonov pot} je pot d grafu, ki vsebuje vsa vozlišča. Graf je \df{Hamiltonov}, če premore Hamiltonov cikel.
\end{definicija}
...
\begin{definicija}
    Graf $G$ je \df{ravninski}, če ga lahko narišemo v ravnini tako, da se povezave ne križajo. Ravninski graf skupaj z ustrezni rusbi v ravnini, je graf \df{vložen v ravnino}.
\end{definicija}
