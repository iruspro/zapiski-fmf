...
Naj bo \(f: X \to Y\) preslikava. Družina \(\setb{\invimg{f}(y)}{y \in \img{f}(X)}\) je \df{razdelitev} množice \(X\). V tej družine so množice paroma disjunktne. Torej ta družina določa ekvivalenčno relacijo na \(X\) in obratno, vsaka ekvivalenčna relacija na \(X\) določna razdelitev na ekvivalenčne razrede.  