...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \df{Notranji avtomorfizem $\varphi_a$} grupe $G$. Kaj lahko povemo o konjugiranih podgrupih?
        \item \df{Grupa $\Aut(G)$} vseh avtomorfizmov. \df{Grupa $\Inn(G)$} vseh notranjih avtomorfizmov.
    ...
    \begin{itemize}
        \item Naj bo $K$ komutativen kolobar. \df{Evalvacijski homomorfizem.}
        \begin{itemize}
        ...
        \item \df{Notranji avtomorfizem $\varphi_a$} kolobarja $K$.
