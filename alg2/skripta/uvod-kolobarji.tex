...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Algebra funkcij $\R^X$. Kaj dobimo, če je $X = \N$? \df{Algebra realnih zaporedij}.
        \item \df{Kolobar polinomov ene spremenljivke}.
        \begin{itemize}
        ...
        \end{itemize}
        \item \df{Kolobar formalnih potenčnih vrst $K[[X]]$}.
        \item \df{Kolobar polinomov več spremenljivk.}
        \begin{itemize}
        ...
        \end{itemize}
        \item Naj bo $K$ cel kolobar. Kako ga povečamo do polja? \df{Polje ulomkov celega kolobarja $K$}.
        \begin{itemize}
        ...
        \item \df{Kolobar matrik $M_n(K)$} nad kolobarjem $K$.
        \begin{itemize}
        ...
        \newpage
        \item \df{Kolobar endomorfizmov $\End_F (V)$} vektorskega prostora $V$ nad poljem $F$.
        \begin{itemize}
        ...
        \item \df{Algebra kvaternionov $\HH$}.
        \begin{itemize}
            ...
            \item \colorbox{purple!30}{\textbf{Definicija.}} \df{Kvaternionska grupa $Q$}.
            \item \colorbox{yellow!30}{\emph{Opomba.}} Ali so $\R, \C, \HH$ edini končnorazsežne realne algebre, ki so obsegi?
        \end{itemize}

        \item \df{Direktni produkt kolobarjev}.
        \begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item \df{Algebra $C(X)$} vseh zveznih funkcij.
            \item Množica $c$ konvergentnih zaporedij v algebre realnih zaporedij.
            \item 
        \end{itemize}
        \item \colorbox{yellow!30}{\emph{Primer.}} \df{Kolobar Gaussovih celih števil $\Z[i]$}.
        \item \colorbox{yellow!30}{\emph{Primer.}} \df{Center $Z(K)$} kolobarja $K$.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \colorbox{blue!30}{\textbf{Trditev.}} Ali je $\Z_n$ komutativen kolobar? \df{Kolobar $\Z_n$} ostankov po modulu $n$.
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \df{Boolov kolobar.} Primer Boolova kolobarja.
    \end{itemize}
