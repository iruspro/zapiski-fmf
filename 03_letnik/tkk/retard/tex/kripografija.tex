...
\end{definicija}
\begin{opomba} 
    Za vse \(k \in \K\) je funkcija \(E_k\) injektivna, sledi da \(|\B| \leq |C|\).
\end{opomba}

Naslednje vprašanje je, kdaj je kriptosistem varen? Definicije varnosti temeljijo na naslednjem načelu.
