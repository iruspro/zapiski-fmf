...
\end{align*}
Torej potrebujemo manjši \(\eps\), da dobimo dobro aproksimacijo.

\subsection{Bisekcija}
\begin{izrek}[o bisekciji]
    Naj bo \(f: [a, b] \to \R\) zvezna in \(f(a) \cdot f(b) \leq 0\). Tedaj obstaja \(c \in (a, b)\), da je \(f(c) = 0.\)
\end{izrek}
...
V vsakem koraku potrebujemo en nov izračun funkcije \(f\), razen na začetku \(2\). Na začetku še potrebujemo sve začetni vrednosti \(x_0,\ x_1\), ni pa kakšnih dodatnih omejitev, kot pri bisekciji.
