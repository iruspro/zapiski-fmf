...
Naj bo $M \subseteq \R^{n+m}, \ M \neq \emptyset$. Množica $M$ je \df{gladka podmnogoterost} dimenzije $n$ prostora $\R^{n+m}$, če za vsako točko~$a \in M$ obstaja okolica $U$ v $\R^{n+m}$ in take $C^1$ funkcije $F_1, \ldots, F_m: U \to \R$, da velja:
\begin{enumerate}
