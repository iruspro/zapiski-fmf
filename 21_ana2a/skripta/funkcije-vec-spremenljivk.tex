...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \colorbox{yellow!30}{\emph{Opomba.}} Kako lahko odvajamo izraz \(F(x, \varphi(x)) = 0\) po spremenljivke \(x\)?
        \item \colorbox{blue!30}{\textbf{Izrek.}} Izrek o implicitni funkciji. \todo{*}
        \item \colorbox{orange!30}{\textbf{Posledica.}} Kaj če je $F$ razreda $C^k(D)$?
